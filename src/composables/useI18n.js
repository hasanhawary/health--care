...
const STRINGS = {
  ...
  radiusFilter: { ar: 'النطاق المحيط بك', en: 'Radius around you' },
  allDistances: { ar: 'كل المسافات', en: 'All distances' },
  within: { ar: 'خلال', en: 'Within' },
  ...
  needsCoordinates: { ar: 'بحاجة إلى إحداثيات', en: 'Needs coordinates' },
  mapPlaceholderTitle: {
